...
<?php } ?>
            ...
            // Function that checks if the current option in the drop down menu is pseudonymized. If so, print information stating the pseudonymization in a html tag.
            ...
            // Function that checks if the current user is a admin or not. Only admins have the right to export the data for de-pseudonymization.    
                ...
                <form action="index.php" method="get" id="form">
                    ...
                    foreach ($ordered_datasets as $groupname => $group) {
                        ...
                        foreach ($group as $key => $set) {
                            ...
                            // If our current choice in the drop down-menu is marked for pseudonymization then the page should act in a certain way. An action that is initiated by chosing a option with a certain ID.
                    ...
                    <!--Showing the button for export of the pseudonymization table.-->
                    <h3 >Export Pseudonymization table</h3>
                    <button onclick="exportpseudonymization();
                            return false;"> Download the pseudonymization table</button>
...
if ($numlinktweets) {
    ...
    $sql .= sqlSubset($where);
    if ($data = pdo_fastquery($sql, $dbh) && $data['count'] / $numlinktweets > 0.5)
                ...
                <form action="index.php" method="get" id="form2">
                    <table>
                        <tr>
                            ...
                            <td><input type="submit" value="update graph" onclick="sendUrl('index.php');
                                    return false;" /></td>
                        </tr>
                    </table>
                </form>
                                                                    ...
                                                                    <input type='radio' name="interval" value="monthly"<?php if ($interval == 'monthly') print " CHECKED"; ?> id="tsam5"> <label for="tsam5">per month</label>
                                                                        <input type='radio' name="interval" value="yearly"<?php if ($interval == 'yearly') print " CHECKED"; ?> id="tsam6"> <label for="tsam6">per year</label>
                                                                            <input type='radio' name="interval" value="custom"<?php if ($interval == 'custom') print " CHECKED"; ?> id="tsam7"> <label for="tsam7">custom:</label>
                                                                                <input type='text' name='customInterval' size='50' value='<?php if (!empty($intervalDates)) print $_REQUEST['customInterval'];
else print "YYYY-MM-DD;YYYY-MM-DD;...;YYYY-MM-DD"; ?>'/>
                                                                                </form>
                                                                                </div>
                                                                                ...
                                                                                <div class="txt_link"> &raquo;  <a href="" onclick="$('#whattodo').val('tweet.stats' + getInterval());
                                                                                        sendUrl('mod.tweet.stats.php');
                                                                                        return false;">launch</a></div>
                                                                                ...
                                                                                <div class="txt_desc">Use: get a better feel for the users in your data set.</div>
                                                                                <div class="txt_link"> &raquo;  <a href="" onclick="$('#whattodo').val('user.list' + getInterval()); sendUrl('mod.user.list.php');
                                                                                        return false;">launch</a></div>
                                                                                ...
                                                                                <div class="txt_link"> &raquo;  <a href="" onclick="$('#whattodo').val('mod.hashtag_user_activity');
                                                                                        sendUrl('mod.hashtag_user_activity.php');return false;">launch</a></div>
                                                                                ...
                                                                                <div class="txt_link"> &raquo;  <a href="index.php?" onclick="var minf = askFrequency();
                                                                                        $('#whattodo').val('source&minf=' + minf + getInterval()); sendUrl('index.php');return false;">launch</a></div>
                                                                                ...
                                                                                <div class="txt_link"> &raquo;  <a href="" onclick="$('#whattodo').val('source.stats' + getInterval()); sendUrl('mod.source.stats.php');
                                                                                        return false;">launch</a></div>
                                                                                ...
                                                                                <div class="txt_desc">Use: get a better feel for the sources in your data set.</div>
                                                                                <div class="txt_link"> &raquo;  <a href="" onclick="$('#whattodo').val('source.list' + getInterval());
                                                                                        sendUrl('mod.source.list.php');
                                                                                        return false;">launch</a></div>
                                                                                ...
                                                                                <div class="txt_link"> &raquo;  <a href="" onclick="var minf = askFrequency();
                                                                                        $('#whattodo').val('mention&minf=' + minf + getInterval());
                                                                                        sendUrl('index.php');
                                                                                        return false;">launch</a></div>
                                                                                ...
                                                                                <div class="txt_link"> &raquo;  <a href="" onclick="var minf = askFrequency();
                                                                                        $('#whattodo').val('user&minf=' + minf + getInterval());
                                                                                        sendUrl('index.php');
                                                                                        return false;">launch</a></div>
                                                                                ...
                                                                                <div class="txt_link"> &raquo;  <a href="" onclick="$('#whattodo').val('user-mention' + getInterval()); sendUrl('index.php');
                                                                                        return false;">launch</a></div>
...
<?php if ($show_url_export) { ?>
                                                                                    ...
                                                                                    <div class="txt_link"> &raquo;  <a href="" onclick="var minf = askFrequency();
                                                                                            $('#whattodo').val('urls&minf=' + minf + getInterval()); sendUrl('index.php');return false;">launch</a></div>
                                                                                    ...
                                                                                    <div class="txt_link"> &raquo;  <a href="" onclick="var minf = askFrequency();
                                                                                            $('#whattodo').val('hosts&minf=' + minf + getInterval());
                                                                                            sendUrl('index.php');
                                                                                            return false;">launch</a></div>
<?php } ?>
                                                                                ...
                                                                                <div class="txt_link"> &raquo;  <a href="" onclick="var minf = askFrequency();
                                                                                        $('#whattodo').val('retweet&minf=' + minf + getInterval());
                                                                                        sendUrl('index.php');return false;">launch</a></div>
                                                                                ...
                                                                                <div class="txt_link"> &raquo;  <a href="" onclick="var lowercase = askLowercase(); var minf = askFrequency();
                                                                                        $('#whattodo').val('word_frequency&lowercase=' + lowercase + '&minf=' + minf + getInterval());
                                                                                        sendUrl('mod.word_frequency.php');
                                                                                        return false;">launch</a></div>
                                                                                ...
                                                                                <div class="txt_link"> &raquo;  <a href="" onclick="var minf = askMediaFrequency();
                                                                                        $('#whattodo').val('media_frequency&minf=' + minf + getInterval());
                                                                                        sendUrl('mod.media_frequency.php');
                                                                                        return false;">launch</a></div>
                                                                                ...
                                                                                <div class="txt_link"> &raquo; <a href="" onclick="$('#whattodo').val('gaps');
                                                                                        sendUrl('mod.gaps.php');
                                                                                        return false;">launch</a></div>
...
<?php } ?>
                                                                                            ...
                                                                                            <input type='checkbox' name="exportSettings" value="hashtags" <?php if (array_search("hashtags", $exportSettings) !== false) print "CHECKED"; ?> id="esHashtags"> <label for="esHashtags">hashtags</label>
                                                                                                <input type='checkbox' name="exportSettings" value="media" <?php if (array_search("media", $exportSettings) !== false) print "CHECKED"; ?> id="esMedia"> <label for="esMedia">media</label>
                                                                                                    ...
                                                                                                    <div class="txt_link"> &raquo;  <a href="" onclick="$('#whattodo').val('export_tweets&random=1' + getExportSettings());
                                                                                                            sendUrl('mod.export_tweets.php');
                                                                                                    ...
                                                                                                    <div class="txt_link"> &raquo;  <a href="" onclick="$('#whattodo').val('export_tweets' + getExportSettings());
                                                                                                            sendUrl('mod.export_tweets.php');
                                                                                                            return false;">download</a></div>
                                                                                                    <hr />
...
<?php if ($show_lang_export) { ?>
                                                                                                        ...
                                                                                                        <div class="txt_desc">Use: spend time with your data.</div>
                                                                                                        <div class="txt_link"> &raquo;  <a href="" onclick="$('#whattodo').val('export_tweets');
                                                                                                                sendUrl('mod.export_tweets_lang.php');return false;">export</a></div>
    <?php if ($show_url_export) { ?>
                                                                                                            <div class="txt_link"> &raquo;  <a href="" onclick="$('#whattodo').val('export_tweets&includeUrls=1');
                                                                                                                    sendUrl('mod.export_tweets_lang.php');return false;">export with URLs</a> (much slower)</div>
                                                                                                        <?php } ?>
                                                                                                        <hr />
<?php } ?>
                                                                                                    ...
                                                                                                    <div class="txt_link"> &raquo; <a href="" onclick="var minf = askRetweetFrequency();
                                                                                                            $('#whattodo').val('retweets_chain&minf=' + minf + getExportSettings());sendUrl('mod.retweets_chain.php');return false;">download</a></div>
                                                                                                    ...
                                                                                                    <div class="txt_link"> &raquo;  <a href="" onclick="$('#whattodo').val('export_tweets&location=1' + getExportSettings());
                                                                                                            sendUrl('mod.export_tweets.php');return false;">download</a></div>
                                                                                                    ...
                                                                                                    <div class="txt_desc"></div>
                                                                                                    <div class="txt_link"> &raquo;  <a href="" onclick="$('#whattodo').val('export_tweet_ids');
                                                                                                            sendUrl('mod.export_tweet_ids.php');
                                                                                                            return false;">download</a></div>
                                                                                                    ...
                                                                                                    <div class="txt_desc"></div>
                                                                                                    <div class="txt_link"> &raquo;  <a href="" onclick="$('#whattodo').val('export_hashtags');sendUrl('mod.export_hashtags.php');
                                                                                                            return false;">download</a></div>
                                                                                                    ...
                                                                                                    <div class="txt_desc"></div>
                                                                                                    <div class="txt_link"> &raquo;  <a href="" onclick="$('#whattodo').val('export_mentions');
                                                                                                            sendUrl('mod.export_mentions.php');
                                                                                                            return false;">download</a></div>
...
<?php } ?>
                                                                                                    ...
                                                                                                    <div class="if_export_block">
                                                                                                        ...
                                                                                                        <div class="txt_link"> &raquo; <a href="" onclick="var topu = askMentions();
                                                                                                                $('#whattodo').val('mention_graph&topu=' + topu);
                                                                                                                sendUrl('mod.mention_graph.php');
                                                                                                                return false;">launch</a></div>
                                                                                                        ...
                                                                                                        <div class="txt_desc">Use: analyze patterns in communication, find "hubs" and "communities", categorize user accounts.</div>
                                                                                                        <div class="txt_link"> &raquo; <a href="" onclick="var minf = askInteractionFrequency();
                                                                                                                if (minf != false) {
                                                                                                                    $('#whattodo').val('interaction_graph&minf=' + minf);
                                                                                                                    sendUrl('mod.interaction_graph.php');
                                                                                                                }
                                                                                                                return false;">launch</a></div>
...
<?php if ($show_relations_export) { ?>
                                                                                                            ...
                                                                                                            <div class="txt_link"> &raquo;  <a href="" onclick="$('#whattodo').val('relations'); sendUrl('mod.relations.php');
                                                                                                                    return false;">launch</a></div>
...
<?php } ?>
                                                                                                        ...
                                                                                                        <div class="txt_link"> &raquo; <a href="" onclick="var minf = askFrequency();
                                                                                                                if (minf !== false) {
                                                                                                                    $('#whattodo').val('hashtag_cooc&minf=' + minf);
                                                                                                                    sendUrl('mod.hashtag_cooc.php'); } return false;">launch</a> (set minimum frequency)</div><!-- with absolute weighting of cooccurrences</a></div>-->
                                                                                                        <div class="txt_link"> &raquo; <a href="" onclick="var topu = askTopht();
                                                                                                                if (topu !== false) {
                                                                                                                    $('#whattodo').val('hashtag_cooc&topu=' + topu);
                                                                                                                    sendUrl('mod.hashtag_cooc.php'); } return false;">launch</a> (get top hashtags)</div>
                                                                                                        ...
                                                                                                        <div class="txt_link"> &raquo; <a href="" onclick="$('#whattodo').val('hashtag_user');
                                                                                                                sendUrl('mod.hashtag_user.php');
                                                                                                                return false;">launch</a></div>
                                                                                                        ...
                                                                                                        <div class="txt_link"> &raquo; <a href="" onclick="$('#whattodo').val('mention_hashtags');
                                                                                                                sendUrl('mod.mention_hashtags.php');
                                                                                                                return false;">launch</a></div>
                                                                                                        ...
                                                                                                        <div class="txt_link"> &raquo; <a href="" onclick="$('#whattodo').val('mod.sources_hashtags');
                                                                                                                sendUrl('mod.sources_hashtags.php');return false;">launch</a></div>
                                                                                                        ...
                                                                                                        <div class="txt_link"> &raquo; <a href="" onclick="$('#whattodo').val('mod.sources_users');
                                                                                                                sendUrl('mod.sources_users.php');
                                                                                                                return false;">launch</a></div>
...
<?php if ($show_url_export) { ?>
                                                                                                            ...
                                                                                                            <div class="txt_link"> &raquo; <a href="" onclick="$('#whattodo').val('mod.sources_hosts');
                                                                                                                    sendUrl('mod.sources_hosts.php');
                                                                                                                    return false;">launch</a></div>
                                                                                                            ...
                                                                                                            <div class="txt_link"> &raquo; <a href="" onclick="$('#whattodo').val('host_user');
                                                                                                                    sendUrl('mod.host_user.php');
                                                                                                                    return false;">launch</a></div>
                                                                                                            ...
                                                                                                            <div class="txt_link"> &raquo;  <a href="" onclick="$('#whattodo').val('url_hashtags');
                                                                                                                    sendUrl('mod.url_hashtags.php');
                                                                                                                    return false;">launch</a></div>
                                                                                                            ...
                                                                                                            <div class="txt_link"> &raquo;  <a href="" onclick="$('#whattodo').val('hosts_hashtags');
                                                                                                                    sendUrl('mod.hosts_hashtags.php');return false;">launch</a></div>
<?php } ?>
                                                                                                    ...
                                                                                                    <div class='if_export_block'>
                                                                                                        ...
                                                                                                        <div class="txt_link"> &raquo; <a href="" onclick="var minf = askCascadeFrequency();
                                                                                                                $('#whattodo').val('cascade&minf=' + minf);
                                                                                                                sendUrl('mod.cascade.php');
                                                                                                                return false;">launch</a></div>
                                                                                                        ...
                                                                                                        <div class="txt_link"> &raquo; <a href="" onclick="$('#whattodo').val('mod.sankeymaker');
                                                                                                                sendUrl('mod.sankeymaker.php');
                                                                                                                return false;">launch</a></div>
                                                                                                        ...
                                                                                                        <div class="txt_link"> &raquo; <a href="" onclick="$('#whattodo').val('hashtag_variability');
                                                                                                                sendUrl('mod.hashtag_variability.php');
                                                                                                                return false;">launch</a></div>
                                                                                                        ...
                                                                                                        <div class="txt_link"> &raquo; <a href="" onclick="$('#whattodo').val('modulation_sequencer');
                                                                                                                sendUrl('mod.modulation_sequencer.php');
                                                                                                                return false;">launch</a></div>
